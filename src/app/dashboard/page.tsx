      ...
      <div className="grid gap-7 xl:grid-cols-[1.25fr_0.75fr] xl:items-stretch">
        <div className="flex min-h-[360px] flex-col">
          ...
          <div className="mt-10 max-w-4xl">
            ...
            <h1 className="mt-3 max-w-3xl text-4xl font-bold leading-[1.05] tracking-tight text-ink sm:text-[40px]">
              Bu ay finansal olarak {health.headline}.
            </h1>
            <p className="mt-4 max-w-2xl text-base font-medium leading-7 text-steel">{health.description}</p>
