  ...
  return (
    <AppShell>
      <section className="rounded-lg border border-ink/10 bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-ink/60">{trCopy.plan.description}</p>
        {cannotBuildUsefulPlan ? (
          <div className="mt-6 rounded-md border border-dashed border-ink/15 bg-ink/[0.02] p-4">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-ink/60">
              ...
              gerçek SQLite verisiyle çalışır; mock veri otomatik kullanılmaz.
            </p>
            ...
            <div className="rounded-lg border border-ink/10 bg-white p-5 shadow-sm">
              ...
              <div className="mt-4 space-y-3">
                {monthlyPlan.actionPlan.map((action) => (
                  <article key={action.id} className="rounded-md border border-ink/10 bg-ink/[0.02] p-4">
                    <div className="flex items-start justify-between gap-3">
                      <h3 className="text-sm font-semibold">{action.title}</h3>
                      <span className="rounded-md bg-white px-2 py-1 text-xs font-semibold text-steel">
